...
本文档用于指导开发者快速准备 Zino分镜助手 的本地开发环境，并了解日常开发注意事项。

## 1. 必备工具

安装与配置教程请先阅读：
[基础工具安装配置（Windows / macOS）](d:/VibeCode/Zino-Storyboard-Copilot/docs/development-guides/base-tools-installation.md)
...
- 新增模型/供应商：参考
  [provider-and-model-extension.md](d:/VibeCode/Zino-Storyboard-Copilot/docs/development-guides/provider-and-model-extension.md)
